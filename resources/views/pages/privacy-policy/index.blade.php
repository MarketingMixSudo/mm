<x-layouts.app title="Wideo i zdjęcia apartamentów, hoteli i restauracji | MarketingMix"
  ...
  "itemListElement": [{
    ...
    "item": "https://marketingmix.pl/polityka-prywatnosci/"  
  }]
}
    </script>
    @endslot
    ...
    <x-hero title="Polityka prywatności">
        <x-breadcrumbs.nav>
            <x-breadcrumbs.item href="{{route('privacyPolicy')}}" title="Polityka prywatności" class="font-medium" />
        </x-breadcrumbs.nav>
    ...
    <section class="section">
        ...
        <div class="wrapper !max-w-screen-lg prose__content">
            ...
            <h2 class="prose__heading">Polityka prywatności opisuje zasady przetwarzania przez nas informacji na Twój temat, w tym danych osobowych oraz ciasteczek, czyli tzw. cookies.</h2>

<h3>1. Informacje ogólne</h3>
<p>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem URL: <strong>marketingmix.pl</strong></p>
<p>Operatorem serwisu oraz Administratorem danych osobowych jest:</p>
<p><strong>MarketingMix sp. z o.o.</strong><br>
ul. Ludźmierska 26A<br>
34-400 Nowy Targ</p>
<p>Adres kontaktowy poczty elektronicznej operatora: <a href="mailto:hello@marketingmix.pl">hello@marketingmix.pl</a></p>
...
<p>Twoje dane osobowe przetwarzane są przez Administratora nie dłużej, niż jest to konieczne do wykonania związanych z nimi czynności określonych osobnymi przepisami (np. o prowadzeniu rachunkowości). W odniesieniu do danych marketingowych dane nie będą przetwarzane dłużej niż przez 3 lata.</p>
...
<p>Dane osobowe nie są przekazywane do krajów trzecich w rozumieniu przepisów o ochronie danych osobowych. Oznacza to, że nie przesyłamy ich poza teren Unii Europejskiej.</p>
...
<p>Operator stosuje analizę statystyczną ruchu na stronie, poprzez Google Analytics (Google Inc. z siedzibą w USA). Operator nie przekazuje do operatora tej usługi danych osobowych, a jedynie zanonimizowane informacje. Usługa bazuje na wykorzystaniu ciasteczek w urządzeniu końcowym użytkownika. W zakresie informacji o preferencjach użytkownika gromadzonych przez sieć reklamową Google użytkownik może przeglądać i edytować informacje wynikające z plików cookies przy pomocy narzędzia: <a href="https://www.google.com/ads/preferences/" target="_blank" rel="noopener noreferrer">https://www.google.com/ads/preferences/</a></p>
...
<p>Operator stosuje rozwiązania automatyzujące działanie Serwisu w odniesieniu do użytkowników, np. mogące przesłać maila do użytkownika po odwiedzeniu konkretnej podstrony, o ile wyraził on zgodę na otrzymywanie korespondencji handlowej od Operatora.</p>
...
<ul>
  ...
  <li>realizacja celów określonych powyżej w części „Istotne techniki marketingowe”;</li>
</ul>
