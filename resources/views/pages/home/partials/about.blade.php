<x-section-double-image image="/dummy/service.jpg" alt="Stworzymy pozytywny wizerunek Twojej firmy">
    <span class="section__preheading">Zajmiemy się Twoją obecnością w internecie</span>
    <h2 class="section__heading">Stworzymy pozytywny wizerunek Twojej firmy</h2>
    <p class="section__text">Serdecznie zachęcamy do zapoznania się ze szczegółami naszej oferty usługowej, która swoim
        zakresem
...
<x-section-double-image reverse image="/dummy/service.jpg" alt="Stworzymy pozytywny wizerunek Twojej firmy"
    ...
    <p class="section__text">
        ...
        Zadbaliśmy o to, aby nasza oferta miała charakter kompleksowy. Klienci mogą liczyć m.in. na
        <strong>projektowanie
        ...
        Wszystko po to, aby identyfikacja wizualna marki w jak najkrótszym czasie przyniosła pożądane efekty, do których
        w
        pierwszej kolejności należy zaliczyć zwiększenie liczby kontrahentów i wzrost sprzedaży. Co równie istotne –
        nasze
