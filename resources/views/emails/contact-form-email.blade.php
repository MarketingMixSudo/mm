...
<body
    ...
    <div role="article" aria-roledescription="email" aria-label="Nowa wiadomość ze strony marketingmix.pl" lang="pl">
        <div class="sm-px-4"
                        ...
                        <div class="sm-my-8" style="margin-top: 48px; margin-bottom: 48px; text-align: center">
                            <a href="https://marketingmix.pl">
                                <img src="{{ asset('email/logo.png') }}" width="200"
                                    alt="logo marketingmix" style="max-width: 100%; vertical-align: middle">
                            </a>
                        </div>
                            ...
                            <tr>
                                <td class="sm-px-6"
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <a href="tel:{{ $phone }}"
                                                style="color: #f8fafc; background-color: #b31c83; display: inline-block; border-radius: 4px; padding: 16px 24px; font-size: 16px; line-height: 1; font-weight: 600; text-decoration: none">
                                                <!--[if mso]>
