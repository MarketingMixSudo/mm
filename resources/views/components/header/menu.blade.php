...
<div id="menu"
    class="fixed top-0 bottom-0 right-0 left-0 sm:left-[50%] lg:left-[60%] 2xl:left-[75%]  flex flex-col justify-between px-7 py-5  bg-primary-400 text-font-light  opacity-0 duration-300 ease-out z-50 translate-x-[100%] overflow-y-auto "
        ...
        <div class="flex justify-end  gap-2 pr-2">
            ...
            <div class="border-l pl-2 flex justify-center items-center gap-2 pt-0.5">
                <a href="tel:+48 453 400 244" class="group" aria-label="telefon">
                    <x-lucide-phone class="w-5 stroke-1 text-white group-hover:scale-110 duration-300" />
                </a>
                <a href="mailto:hello@marketingmix.pl" class="group" aria-label="mail">
                    <x-lucide-mail class="w-5 stroke-1 text-white group-hover:scale-110 duration-300" />
                </a>
            </div>
        </div>
    </div>
